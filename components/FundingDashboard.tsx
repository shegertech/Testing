...
import { Lock, Clock, AlertCircle, CheckCircle, Loader } from 'lucide-react';
        ...
        <>
            {view === 'create' ? (
                ...
                <div className="grid gap-6">
                    {opportunities.length === 0 && <p className="text-gray-500">No opportunities available right now.</p>}
